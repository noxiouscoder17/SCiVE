...
public class NNet : MonoBehaviour
{
    ...
    public void Initialise(int hiddenLayerCount, int hiddenNeuronCount)
    {
        ...
        for(int i= 0; i<hiddenLayerCount + 1; i++)
        {
            ...
            if(i==0)
            {
                Matrix<float> inputToH1 = Matrix<float>.Build.Dense(8, hiddenNeuronCount);
    ...
    public (float, float) RunNetwork (float a, float b, float c, float d, float e, float f, float g, float h)
    {
